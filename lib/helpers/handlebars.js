...
/**
 * Converts Swagger schema object to Joi definition.
 */
Handlebars.registerHelper('joiDefinition', (schema, isRequired, options) => {
  if (arguments.length < 3) {
    throw new Error('Handlebars Helper "joiDefinition" needs 2 parameters');
  }
